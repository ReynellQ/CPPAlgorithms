...
\section{Grafos}
    ...
    \subsection{Floyd-Warshall}
        ...
        C++
        \lstinputlisting[language=C++]{C++/Grafos/FloydWarshall.cpp}
    ...
    \subsection{Bellman-Ford}
        ...
        \\ \\
        C++
        \lstinputlisting[language=C++]{C++/Grafos/BellmanFord.cpp}
...
\section{Matemáticas}
    \subsection{Función $\phi$ de Euler}
        Permite calcular $\phi(n)$, que equivale a los números menores que n y coprimos a este. Para números primos, $\phi(n)= n - 1$ 
        \\ \\
        C++:
        \lstinputlisting[language=C++]{C++/Matematicas/euler_phi.cpp}
    ...
    \subsection{Exponenciacion binaria}
        ...
        \\ \\
        Para valores de b muy grandes, $ a^b \equiv a^{b\mod{\phi(m)}} \pmod{m}$.
        \\
        Siguiendo lo anterior, si m es primo: $ a^b \equiv a^{b\mod{m - 1}}\pmod{m}$
        \\ \\
        C++:
